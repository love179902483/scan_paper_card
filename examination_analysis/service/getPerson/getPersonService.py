...
import cv2
import numpy as np
from myutil.util import evaluateTolerance

class GetPersonInfo():
    def __init__(self, thisImage, multipleVariable, pageVariable):

        # 选择题外层的框子
        self.allWidth = multipleVariable['allWidth']
        self.allHeight = multipleVariable['allHeight']
        self.allStartPoint = multipleVariable['allStartPoint']

        # 选择题内层的框子
        self.width = multipleVariable['width']
        self.height = ['height']
        self.startPoint = multipleVariable['startPoint']
        self.circumference = multipleVariable['circumference']
        self.area = multipleVariable['area']
        self.tolerance = multipleVariable['tolerance']
